...
//        tabbedPane.setBackground(Color.white);
        ...
        tabbedPane.setTitleAt(0, "tab1");
        tabbedPane.addTab("tab2", panel2);
        tabbedPane.setEnabledAt(1, true);
        tabbedPane.setTitleAt(1, "tab2");*/
    ...
    private JTabbedPane initTabledPane(String[] tabs){
        ...
        image.setImage(image.getImage().getScaledInstance(AER.TAB_ICON_WIDTH, AER.TAB_ICON_HEIGHT, Image.SCALE_DEFAULT));
